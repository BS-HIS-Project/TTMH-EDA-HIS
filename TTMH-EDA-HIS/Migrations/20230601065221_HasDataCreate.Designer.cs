...
namespace TTMH_EDA_HIS.Migrations
{
    ...
    [Migration("20230601065221_HasDataCreate")]
    partial class HasDataCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TTMH_EDA_HIS.Models.Chart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Object = "心臟病",
                            Subject = "胸悶",
                            Vdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("TTMH_EDA_HIS.Models.DoctorsPatientsChart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DoctorId = "D11201001",
                            PatientId = "A118992634",
                            ChaId = "CHA20230531001001"
                        },
                        new
                        {
                            DoctorId = "D11201001",
                            PatientId = "O101929955",
                            ChaId = "CHA20230531001002"
                        },
                        new
                        {
                            DoctorId = "D11201002",
                            PatientId = "H255590997",
                            ChaId = "CHA20230531001003"
                        },
                        new
                        {
                            DoctorId = "D11201002",
                            PatientId = "L198058112",
                            ChaId = "CHA20230531001004"
                        },
                        new
                        {
                            DoctorId = "D11201002",
                            PatientId = "S257920071",
                            ChaId = "CHA20230531001005"
                        });
                });
            ...
            modelBuilder.Entity("TTMH_EDA_HIS.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatientId = "A118992634",
                            Address = "台北市",
                            BirthDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(47),
                            Blood = "A",
                        ...
                        new
                        {
                            PatientId = "H255590997",
                            Address = "桃園市",
                            BirthDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(19),
                            Blood = "AB",
                        ...
                        new
                        {
                            PatientId = "S257920071",
                            Address = "高雄市",
                            BirthDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(34),
                            Blood = "O",
            ...
            modelBuilder.Entity("TTMH_EDA_HIS.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DrugDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13),
                            PatientId = "A118992634",
                            PhaId = "P11201001"
                        },
                        new
