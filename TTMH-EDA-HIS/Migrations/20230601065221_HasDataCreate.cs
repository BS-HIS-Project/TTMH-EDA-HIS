...
{
    /// <inheritdoc />
    public partial class HasDataCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CHA20230530001001", "心臟內科", "心臟病", "胸悶", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13) },
                    { "CHA20230530001002", "心臟內科", "心臟病", "心跳好像一直不規律，呼吸不過來", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13) },
                    { "CHA20230530001003", "心臟內科", "心臟病", "頭痛、噁心、冒冷汗", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13) },
                    { "CHA20230530001004", "心臟內科", "心臟病", "呼吸急促、胸悶", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13) },
                    { "CHA20230530001005", "心臟內科", "心臟病", "心臟很痛", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "A118992634", "台北市", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(47), "A", "PAT20160610001001", "1", "0912345678", "000012345678", "水戶黃門" },
                    { "H255590997", "桃園市", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(19), "AB", "PAT20161225001003", "2", "0955664477", "123456789011", "晨曦" },
                    { "L198058112", "台中市", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(7), "O", "PAT20170526001004", "1", "0964973125", "647519785134", "野原新之助" },
                    { "O101929955", "新竹市", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(15), "A", "PAT20160610001002", "1", "0965478932", "080009699912", "海綿寶寶" },
                    { "S257920071", "高雄市", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(34), "O", "PAT20170811001005", "2", "0997919395", "715687493157", "橘子" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CHA20230531001001", "D11201001", "A118992634" },
                    { "CHA20230531001002", "D11201001", "O101929955" },
                    { "CHA20230531001003", "D11201002", "H255590997" },
                    { "CHA20230531001004", "D11201002", "L198058112" },
                    { "CHA20230531001005", "D11201002", "S257920071" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "PRE20230530001001", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13), "A118992634", "P11201001" },
                    { "PRE20230530001002", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13), "O101929955", "P11201001" },
                    { "PRE20230530001003", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13), "H255590997", "P11201001" },
                    { "PRE20230530001004", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13), "L198058112", "P11201001" },
                    { "PRE20230530001005", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(13), "S257920071", "P11201001" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                ...
                keyValues: new object[] { "CHA20230531001001", "D11201001", "A118992634" });

            migrationBuilder.DeleteData(
                table: "Doctors_Patients_Charts",
                keyColumns: new[] { "ChaID", "DoctorID", "PatientID" },
                keyValues: new object[] { "CHA20230531001002", "D11201001", "O101929955" });

            migrationBuilder.DeleteData(
                table: "Doctors_Patients_Charts",
                keyColumns: new[] { "ChaID", "DoctorID", "PatientID" },
                keyValues: new object[] { "CHA20230531001003", "D11201002", "H255590997" });

            migrationBuilder.DeleteData(
                table: "Doctors_Patients_Charts",
                keyColumns: new[] { "ChaID", "DoctorID", "PatientID" },
                keyValues: new object[] { "CHA20230531001004", "D11201002", "L198058112" });

            migrationBuilder.DeleteData(
                table: "Doctors_Patients_Charts",
                keyColumns: new[] { "ChaID", "DoctorID", "PatientID" },
                keyValues: new object[] { "CHA20230531001005", "D11201002", "S257920071" });
