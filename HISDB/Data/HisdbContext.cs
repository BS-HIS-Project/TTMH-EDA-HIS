...
public partial class HisdbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //{
        //    entity.HasKey(e => e.RegistrationId).HasName("PK__Registration__A1B2C3D4E5F6");
        ...
        modelBuilder.Entity<DoctorsPatientsChart>().HasData(
            new DoctorsPatientsChart { DoctorId="D11201001", PatientId= "A118992634", ChaId= "CHA2023053013001001", RegistrationTime = new DateTime(2023, 05, 30, 13, 20, 13) },
            new DoctorsPatientsChart { DoctorId="D11201001", PatientId= "O101929955", ChaId= "CHA2023053013001002", RegistrationTime = new DateTime(2023, 05, 30, 13, 25, 13) },
            new DoctorsPatientsChart { DoctorId="D11201002", PatientId= "H255590997", ChaId= "CHA2023053013001003", RegistrationTime = new DateTime(2023, 05, 30, 13, 37, 13) },
            new DoctorsPatientsChart { DoctorId="D11201002", PatientId= "L198058112", ChaId= "CHA2023053013001004", RegistrationTime = new DateTime(2023, 05, 30, 13, 43, 13) },
            new DoctorsPatientsChart { DoctorId="D11201002", PatientId= "S257920071", ChaId= "CHA2023053013001005", RegistrationTime = new DateTime(2023, 05, 30, 13, 50, 13) },
            new DoctorsPatientsChart { DoctorId="D11201001", PatientId= "O101929955", ChaId= "CHA2023060613001001", RegistrationTime = new DateTime(2023, 06, 06, 13, 18, 13) },
            new DoctorsPatientsChart { DoctorId="D11201001", PatientId= "L198058112", ChaId= "CHA2023060613001002", RegistrationTime = new DateTime(2023, 06, 06, 13, 56, 13) }
        );
        //病人
