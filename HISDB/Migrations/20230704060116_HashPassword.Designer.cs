...
namespace HISDB.Migrations
{
    ...
    [Migration("20230704060116_HashPassword")]
            ...
            modelBuilder.Entity("HISDB.Models.Chart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Object = "心臟病",
                            Subject = "胸悶",
                            Vdate = new DateTime(2023, 5, 30, 9, 20, 13, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Vdate = new DateTime(2023, 5, 30, 9, 53, 13, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Object = "心臟病",
                            Subject = "頭痛、噁心、冒冷汗",
                            Vdate = new DateTime(2023, 5, 30, 15, 20, 13, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Object = "心臟病",
                            Subject = "呼吸急促、胸悶",
                            Vdate = new DateTime(2023, 5, 30, 15, 42, 13, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Object = "心臟病",
                            Subject = "心臟很痛",
                            Vdate = new DateTime(2023, 5, 30, 19, 20, 13, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Object = "心臟病",
                            Subject = "吃完藥會頭暈",
                            Vdate = new DateTime(2023, 6, 6, 19, 39, 13, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ChaId = "CHA2023063011001001",
                            DepartmentName = "心臟內科",
                            History = "先天心臟病",
                            Object = "心臟病",
                            Subject = "有些緩和了",
                            Vdate = new DateTime(2023, 6, 30, 11, 27, 16, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ChaId = "CHA2023063016001002",
                            DepartmentName = "心臟內科",
                            History = "先天心臟病",
                            Object = "心臟病",
                            Subject = "有些緩和了",
                            Vdate = new DateTime(2023, 6, 30, 16, 7, 30, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("HISDB.Models.Detail", b =>
                {
                    ...
                    b.Property<decimal?>("Diagnostic")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("DrugPartialPayment")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HISDB.Models.DoctorsPatientsChart", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PatientId = "AC12345678",
                            ChaId = "CHA2023063011001001",
                            DoctorId = "D11201002"
                        },
                        new
                        {
                            PatientId = "HD12345678",
                            ChaId = "CHA2023063016001002",
                            DoctorId = "D11201002"
                        });
                });
            ...
            modelBuilder.Entity("HISDB.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "D1001",
                            EmployeeName = "YuDaLu",
                            Password = "C7E21D81B12CE45023ED244C4E3C8DCF8F15A3A3C12A94E04B5F139A67AEC9A0534FC5A1387A5B5C63956752B6677FCF98B524FA378277BCA2241FC7E7807FA0"
                        },
                        new
                        {
                            ...
                            Account = "P1002",
                            EmployeeName = "鍾伊惠",
                            Password = "C620C100EE6E040376B0367514B74660499ECBAB0EFB18DBCA49DFD6A1DC19A41FD6F14AE500F9607BF0F0428412AD18F704B4CEE74B636E42272F6E32CCF449"
                        },
                        new
                        {
                            ...
                            Account = "D1003",
                            EmployeeName = "連智健",
                            Password = "894D9AE1387F7FAE80C852727BF4C122E906BC84A00E9F7AA098F81A5114687DE6A1E746A7769B5EA0C5FFF3E14C4D27A562CC2591B8FD811050F6993535F472"
                        },
                        new
                        {
                            ...
                            Account = "C1004",
                            EmployeeName = "盧昱達",
                            Password = "55ACA56A258F8CA90B01594BC4C613B5F5B44F5FB6DAAF5C14DF842D851D2E78324FC4BD1883B821E0B5C21358DFBCDBB30905E80239EDE900B9964934199862"
                        },
                        new
                        {
                            ...
                            Account = "P1005",
                            EmployeeName = "林廣學",
                            Password = "FB8D1C53588E7E238EC43CEDBFC1387FB8CEF974C3ABE50D10E081E4E8B8D9C214FBD54DDD204CDA87E93D309201B4558DF15FF363970E1AFCD8154571FFF97C"
                        },
                        new
                        {
                            ...
                            Account = "C1006",
                            EmployeeName = "Althea",
                            Password = "42F4197EBEF050AD15E15195C53663FCE72C070E069F98F98743D362479618BA5BFB5E10EB72C31DC74AAC003553490D51A6669605520016C81CDD483DA1CD92"
                        });
                });
            ...
            modelBuilder.Entity("HISDB.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PatientId = "AC12345678",
                            Address = "台南市",
                            BirthDate = new DateTime(1982, 9, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Blood = "B",
                            CaseHistory = "PAT2018081113001001",
                            Gender = "1",
                            Mobile = "0997224115",
                            PatientName = "鮭魚",
                            Status = "Japan"
                        ...
                        new
                        {
                            ...
                            Blood = "AB",
                            CaseHistory = "PAT2019081113001001",
                            Gender = "2",
                            Mobile = "0912847214",
                            PatientName = "鯨魚",
                            Status = "Korea"
